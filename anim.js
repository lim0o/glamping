...
const crossBurger = document.querySelector('.menu-burger .crossBurger');
...
window.addEventListener('scroll', () => {
  ...
  if (window.scrollY > seuil) {
    ...
    menuItem.forEach(item => {
      ...
      item.classList.add('menu-item-scrolled');
    });
    burgerSpan.forEach(item => {
      item.style.backgroundColor = '#D2C19F';
    });
  }
  else {
    ...
    menuItem.forEach(item => {
      ...
      item.classList.remove('menu-item-scrolled');
    });
    burgerSpan.forEach(item => {
